...
export const Hero: React.FC<Partial<StaticWrapperSectionProps>> = () => {
  return (
    <div className='hero'>
      ...
      <p className='lead'>
        Explore a new kind of digital representation with cultivated variant
        outputs. With access to a growing collection of unique content you can
        find the piece that draws your attention the most.
      </p>
